<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Women.aspx.cs" Inherits="temppractise.Women" %>
...
<body>
 ...
 <!-- ***** Header Area End ***** -->
    <div>
                <video id="background-video" style="width:100vw;height:75vh; margin-top:70px;object-fit:cover;" autoplay loop muted poster="https://assets.codepen.io/6093409/river.jpg">
...
<br />
           ...
           <br />
                      ...
                      <h1 style="text-align:center; color:white; padding:10px;">Party Outfit</h1>

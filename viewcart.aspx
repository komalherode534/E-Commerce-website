<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewcart.aspx.cs" Inherits="temppractise.viewcart" %>
...
<body>
 ...
 <!-- ***** Header Area End ***** -->
           ...
           <asp:Table runat="server" Width="100%">
               <asp:TableRow>
                   ...
                   <asp:TableCell Width="20%">
                       ...
                       <asp:Button CommandName="bminus" ID="btnminus" runat="server" Text="-" />
                       <asp:TextBox ID="txtqty" runat="server" Text='<%#Eval("pquantity") %>' />
                        <asp:Button CommandName="bplus" ID="btnplus" runat="server" Text="+" />
                   </asp:TableCell><asp:TableCell Width="20%">
   ...
   <p style="margin-right:200px;" align="right">
       ...
       </asp:Label><asp:Button ID="Button4" runat="server" Text="Update" OnClick="Button4_Click" />
       <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Remove " />
       <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="add more items" />
       <asp:Button ID="Button1" runat="server" Text="proceed to buy" OnClick="Button1_Click" />Grand Total : <asp:Label ID="lblgtotal" runat="server" Text="Label"></asp:Label></p>
